...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.digits.setTextFormat(Qt.TextFormat.AutoText)
        self.digits.setScaledContents(False)
        self.digits.setAlignment(Qt.AlignmentFlag.AlignRight|Qt.AlignmentFlag.AlignTrailing|Qt.AlignmentFlag.AlignVCenter)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_pow.setText(QCoreApplication.translate("MainWindow", u"pow", None))
