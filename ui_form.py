...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayoutWidget.setGeometry(QRect(190, 151, 356, 303))
        ...
        self.gridLayout.addWidget(self.clearButton, 5, 3, 1, 1)
        ...
        self.state.setBaseSize(QSize(0, 0))
        font = QFont()
        font.setFamilies([u"Ubuntu Sans"])
        font.setPointSize(10)
        font.setBold(True)
        self.state.setFont(font)
        self.state.setLayoutDirection(Qt.LeftToRight)
        self.state.setTextFormat(Qt.AutoText)
        self.state.setScaledContents(False)
        self.state.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)

        self.gridLayout.addWidget(self.state, 7, 0, 1, 2)

        self.state_2 = QLabel(self.gridLayoutWidget)
        self.state_2.setObjectName(u"state_2")
        self.state_2.setBaseSize(QSize(0, 0))
        self.state_2.setFont(font)
        self.state_2.setTextFormat(Qt.AutoText)
        self.state_2.setScaledContents(False)
        self.state_2.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)

        self.gridLayout.addWidget(self.state_2, 7, 2, 1, 2)
